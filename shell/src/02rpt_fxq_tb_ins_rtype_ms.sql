...
drop table if exists s_rpt_fxq_tb_ins_rtype_ms;

create temporary table s_rpt_fxq_tb_ins_rtype_ms select * from rpt_fxq_tb_ins_rtype_ms where 1 <> 1;

INSERT INTO s_rpt_fxq_tb_ins_rtype_ms (
	head_no, 
	company_code1, 
	ins_type, 
	ins_no, 
...
from s_rpt_fxq_tb_ins_rtype_ms;