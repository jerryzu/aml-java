...
drop table if exists s_rpt_fxq_tb_ins_pers_ms;

create temporary table s_rpt_fxq_tb_ins_pers_ms select * from rpt_fxq_tb_ins_pers_ms where 1 <> 1;
...
INSERT INTO s_rpt_fxq_tb_ins_pers_ms(
        company_code1,
        company_code2,
        cst_no,
        open_time,
