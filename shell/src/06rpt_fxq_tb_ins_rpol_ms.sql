...
--  功能描述: 从保单中间表取保单信息,关联保单被保人受益人信息表获取被保人受益人信息及对应关系,
--  通过保单相关方过滤自然人投保保单形成自然人投保保单导入检查期所有自然人承保及特定业务保单
--   表提取数据
--            导入到 (rpt_fxq_tb_ins_rpol_ms) 表
--  创建者:祖新合 
--  输入: 
--  x_rpt_fxq_tb_ins_rpol_gpol -- 保单中间表(包括个单与团单)
--  edw_cust_ply_party
--  s_rpt_fxq_tb_ins_rpol_ms -- 保单信息、被保人信息与受益人信息表
...
drop table if exists tb_ins_rpol_ms;

create temporary table tb_ins_rpol_ms select * from rpt_fxq_tb_ins_rpol_ms where 1 <> 1;
