...
drop table if exists s_rpt_fxq_tb_ins_gpol_ms;

create temporary table s_rpt_fxq_tb_ins_gpol_ms select * from rpt_fxq_tb_ins_gpol_ms where 1 <> 1;
...
INSERT INTO s_rpt_fxq_tb_ins_gpol_ms(
        company_code1,
        company_code2,
        company_code3,
        pol_no,
