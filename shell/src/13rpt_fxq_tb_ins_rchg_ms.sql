...
drop table if exists s_rpt_fxq_tb_ins_rchg_ms;

create temporary table s_rpt_fxq_tb_ins_rchg_ms select * from rpt_fxq_tb_ins_rchg_ms where 1 <> 1;

INSERT INTO s_rpt_fxq_tb_ins_rchg_ms(
        company_code1,
        company_code2,
        company_code3,
        company_code4,
