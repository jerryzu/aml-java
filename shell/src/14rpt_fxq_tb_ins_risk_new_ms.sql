...
drop table if exists s_rpt_fxq_tb_ins_risk_new_ms;

create temporary table s_rpt_fxq_tb_ins_risk_new_ms select * from rpt_fxq_tb_ins_risk_new_ms where 1 <> 1;

insert into s_rpt_fxq_tb_ins_risk_new_ms(
...
where v.rank = 1 and v.score_time between {beginday} and {endday};
...
from s_rpt_fxq_tb_ins_risk_new_ms;