...
drop table if exists s_rpt_fxq_tb_ins_risk_ms;

create temporary table s_rpt_fxq_tb_ins_risk_ms select * from rpt_fxq_tb_ins_risk_ms where 1 <> 1;

insert into s_rpt_fxq_tb_ins_risk_ms(
