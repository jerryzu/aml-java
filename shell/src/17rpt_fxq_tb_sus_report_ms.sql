...
drop table if exists s_rpt_fxq_tb_sus_report_ms;

create temporary table s_rpt_fxq_tb_sus_report_ms select * from rpt_fxq_tb_sus_report_ms where 1 <> 1;

insert into s_rpt_fxq_tb_sus_report_ms(
    ricd,
    finc,
    senm,
    setp,
...
from s_rpt_fxq_tb_sus_report_ms;