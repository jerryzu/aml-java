 ...
 */
public class MySqlNullCheckedResultSet implements InvocationHandler {
    ...
    static {
        Method[] methods = MySqlNullCheckedResultSet.class.getMethods();
     ...
     * equivalent to:
     * <pre>
     * ProxyFactory.instance().createResultSet(new MySqlNullCheckedResultSet(rs));
     * </pre>
     *
    ...
    public static ResultSet wrap(ResultSet rs) {
        return factory.createResultSet(new MySqlNullCheckedResultSet(rs));
    }
    ...
    private String nullString = "wine";
     ...
     * <code>MySqlNullCheckedResultSet</code>
     * to wrap the specified <code>ResultSet</code>.
     * @param rs ResultSet to wrap
     */
    public MySqlNullCheckedResultSet(ResultSet rs) {
        super();
        this.rs = rs;
    }
